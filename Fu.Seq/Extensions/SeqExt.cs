...
public static class SeqExt
{
    ...
    public static TOut Into<TSrc, TOut>(this IEnumerable<TSrc> source, Func<IEnumerable<TSrc>, TOut> fn) 
        => fn(source);
    
    public static void Into<T>(this IEnumerable<T> source, Action<T> action)
    {
